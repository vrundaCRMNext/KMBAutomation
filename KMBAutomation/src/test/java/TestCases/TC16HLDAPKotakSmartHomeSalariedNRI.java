...
public class TC16HLDAPKotakSmartHomeSalariedNRI extends SetUp 
{
	...
	public HLDAPEndJourney HLSalesEnd ;	
	  @Test
	  public void HLDAPKotakSmartHomeSalariedNRI() throws Exception
	  {
		  String sheetName = "HLDAPKotakSmartHomeSalNRI";
			 
		  if (!(CommonMethods.isTestRunnable("HLDAPKotakSmartHomeSalariedNRI"))) 
		  {
			  throw new SkipException("Skipping the test HLDAPKotakSmartHomeSalariedNRI sas the Run mode is NO");
		  }
